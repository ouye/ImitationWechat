...
- (void)scrollsToTopAnimated:(BOOL)animated{
    ...
    if ([self.dataSource respondsToSelector:@selector(numberOfSectionsInTableView:)]){
        sectionCount = [self.dataSource numberOfSectionsInCollectionView:self];
    }else{
        sectionCount = 1;
    }
    ...
    if (cell) {
        ...
        [self scrollToItemAtIndexPath:indexPath atScrollPosition:UICollectionViewScrollPositionTop animated:animated];
    }
}
